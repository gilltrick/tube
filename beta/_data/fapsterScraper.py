...
def SaveMetaInformationObjectList():
    global metaInformationObjectList
    file = open(os.getcwd()+"/static/data/databases/fapster.db", "wb")
    pickle.dump(metaInformationObjectList, file)
    file.close()
    print("Database saved")

def InitDB():
    if os.path.exists(os.getcwd()+"/static/data/databases/fapster.db"):
        LoadMetaInformationObjectList()
        return
...
def LoadMetaInformationObjectList():
    if os.path.exists(os.getcwd()+"/static/data/databases/fapster.db"):
        global metaInformationObjectList
        file = open(os.getcwd()+"/static/data/databases/fapster.db", "rb")
        try:
