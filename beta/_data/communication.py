import os, pickle, hashlib, datetime, modules, userDatabase
...
def CreateSupportConversation(_userId):
    ...
    senderId = "YOUR_ADMIN_ID"
    senderUsername = "YOUER_ADMIN_USERNAME"
    ...
    SendMessage(senderId, receiverUserObject.id, senderUsername, titleText, messageText, senderNickName)