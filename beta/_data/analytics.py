...
def LoadPornStarAnalyticObjectList():
    ...
    if os.path.exists(os.getcwd()+"/static/data/analytics/pornStarAnalytics.db"):
        try:
            pornStarAnalyticObjectListFile = open(os.getcwd() + "/static/data/analytics/pornStarAnalytics.db", "rb")
            try:
...
def SavePornStarAnalyticObjectList():
    global pornStarAnalyticObjectList
    if os.path.exists(os.getcwd()+"/static/data/analytics/pornStarAnalytics.db"):
        pornStarAnalyticObjectListFile = open(os.getcwd() + "/static/data/analytics/pornStarAnalytics.db", "wb")
