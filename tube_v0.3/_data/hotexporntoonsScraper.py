import requests, re, pickle, hashlib, datetime, os, modules
...
def CreateDictionary(_command):
    if _command == "":
        keyWordDictionary = open(os.getcwd()+ "/static/data/dictionarys/keyWordDictionary" , "r")
        lines = keyWordDictionary.readlines()
        return lines
    if _command == "-pornstar":
        pornStarDictionary = open(os.getcwd()+ "/static/data/dictionarys/pornStarNameDictionary" , "r")
...
def AddTagsToPornStartSearchList():
    ...
    pornStarNameFile = open(os.getcwd()+"/static/data/dictionarys/pornStarNameDictionary" , "r")
...
def InitDB():
    if os.path.exists(os.getcwd()+"/static/data/databases/hotexporntoons.db"):
        LoadMetaInformationObjectList()
        return
    print("HOTEXPORNTOONS: No database file found")
    command = input("HOTEXPORNTOONS: Create a new file? ")
    if command == "yes":
        file = open(os.getcwd()+"/static/data/databases/hotexporntoons.db", "wb")
        file.close()
        Run()
...
def LoadMetaInformationObjectList():
    if os.path.exists(os.getcwd()+"/static/data/databases/hotexporntoons.db"):
        global metaInformationObjectList
        file = open(os.getcwd()+"/static/data/databases/hotexporntoons.db", "rb")
        try:
